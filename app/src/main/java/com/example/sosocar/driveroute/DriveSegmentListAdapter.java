package com.example.sosocar.driveroute;
...
public class DriveSegmentListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position == 0) {
			holder.driveDirIcon.setImageResource(R.drawable.locate_blue_icon);
			holder.driveLineName.setText("起始");
			...
			holder.driveDirIcon.setImageResource(R.drawable.locate_red_icon);
			holder.driveLineName.setText("目的地");
